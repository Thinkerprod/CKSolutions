...
<div class="d-grid col-12 ">
    <button class="btn btn-light fs-1 border-none text-nowrap mt-5 mb-3 " type="button" data-bs-toggle="collapse" data-bs-target="#CurrentProjects" aria-expanded="false" aria-controls="CurrentProjects">Current Projects <i class="material-symbols-outlined fs-3">chevron_right</i></button>
    </div>
...
<div class="d-grid col-12">
  <button class="btn btn-light fs-1 border-none text-nowrap mb-3" type="button" data-bs-toggle="collapse" data-bs-target="#PastProjects" aria-expanded="false" aria-controls="PastProjects">Past Projects <i class="material-symbols-outlined fs-3">chevron_right</i></button>
</div>
  <div class="container bg-white h-100">
